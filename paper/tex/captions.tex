...
The pre-registered sequence, shown as a design rather than a result. A pair is
...
once. The protocol is explicitly UNRUN and UNAUTHORIZED; no value in this
diagram is an observed result.%
}
